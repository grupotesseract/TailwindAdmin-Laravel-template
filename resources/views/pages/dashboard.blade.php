...
<main class="bg-white-medium flex-1 p-3 overflow-hidden">
    ...
    <div class="flex flex-col">
        ...
        <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
            <div class="shadow bg-red-vibrant border-l-8 hover:bg-red-vibrant-dark border-red-vibrant-dark mb-2 p-2 md:w-1/4 mx-2">
                ...
                <div class="table-responsive">
                    <table class="table text-grey-darkest">
                        ...
                        <tr>
                            <th scope="row">1</th>
                            <td>
                                <button class="bg-blue hover:bg-blue-dark text-white font-light py-1 px-2 rounded-full">
                                    Twitter
                                </button>
                            </td>
                            <td>4500</td>
                            <td>4600</td>
                            <td>
                                <span class="text-green"><i class="fas fa-arrow-up"></i>5%</span>
                            </td>
                        </tr>
                        <tr>
                            <th scope="row">2</th>
                            ...
                            <td>3000</td>
                            <td>
                                <span class="text-red"><i class="fas fa-arrow-down"></i>65%</span>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>3000</td>
                            <td>
                                <span class="text-green"><i class="fas fa-arrow-up"></i>65%</span>
                            </td>
                        </tr>
            ...
            <div class="rounded overflow-hidden shadow bg-white mx-2 w-full pt-2">
                ...
                <div class="">
                    <div class="w-full">
                        ...
                        <div class="shadow w-full bg-grey-light mt-2">
                            <div class="bg-red text-xs leading-none py-1 text-center text-white"
                                    style="width: 75%">75%
                            </div>
                        </div>
                    </div>
